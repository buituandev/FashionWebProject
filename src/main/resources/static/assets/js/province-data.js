...
// Remove accents from each province name
const provincesWithoutAccents = provinces.map(removeAccents);

// Get the select element
const selectElement = document.getElementById("country_name");

// Populate the select element with options
provincesWithoutAccents.forEach(province => {
